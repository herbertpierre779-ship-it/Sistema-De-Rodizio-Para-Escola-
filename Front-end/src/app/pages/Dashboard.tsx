                  ...
                  <button
                    ...
                    className={`inline-flex items-center gap-2 rounded-full px-4 py-3 text-sm font-semibold transition ${
                      isActive
                        ...
                        : "border border-white/70 bg-white text-slate-700 shadow-sm shadow-slate-200"
                    }`}
                  >
...
function HeaderCard({ fullName, role, onLogout, showSessionCard = true }: HeaderCardProps) {
  return (
